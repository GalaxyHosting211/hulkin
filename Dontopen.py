...
fbq('track', 'PageView');
</script> <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=542578585845936&ev=PageView&noscript=1"/></noscript> 
...
<script type="text/javascript">
    ...
    var xInterval = setInterval(function () {
        if (--iCountDown) {
            ...
            setTimeout(function () {
                window.location = '/file/ury1jjfwrtrcxc8/Dontopen.py';
            }, 2500);
        }
    }, 1000);
...
<div id="download_repair_wrapper" class="DownloadRepair">
        ...
        <div id="dlRepairMessage2" class="DownloadRepair-generateKeyMessage">
            ...
            <a href="/file/ury1jjfwrtrcxc8/Dontopen.py"
               id="continue-btn"
